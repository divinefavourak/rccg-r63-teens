"""
Seed the RBAC permissions and roles from the code registry so the authorization
cutover has roles to reference immediately on deploy. Idempotent and reversible
(reverse is a no-op — we never delete seeded roles automatically).

Self-contained: uses historical models + the pure-data registry constants.
"""
...
class Migration(migrations.Migration):
    dependencies = [('identity', '0002_roleassignment_updated_at')]
